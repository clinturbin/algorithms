...
/*
    ...
    He enters and leaves only one valley
*/
...
const countingValleys = (n, s) => {
    ...
    let inValley = false;
    for (let i = 0; i < n; i++) {
        currentDepth += s[i] === 'U' ? 1 : -1;
        if (currentDepth < 0) inValley = true;
        if (inValley && currentDepth === 0) {
            valleys++;
            inValley = false;
        }
    }
...
console.log(countingValleys(8, 'UDDUDUUD'));